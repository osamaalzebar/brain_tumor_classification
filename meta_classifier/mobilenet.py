# fine_tune_mobilenetv2_brain_tumor.py
import os
import random
...
BEST_MODEL_PATH = os.path.join(OUTPUT_DIR, "mobilenetv2_best.pth")
...
# -----------------------
# Transforms (with proper ImageNet mean/std)
# -----------------------
...
# -----------------------
# Model: MobileNetV2 with 4-class head
# -----------------------
def build_mobilenet_v2(num_classes: int = 4) -> nn.Module:
    model = models.mobilenet_v2(weights=models.MobileNet_V2_Weights.IMAGENET1K_V2)
    in_features = model.classifier[-1].in_features
    # Replace final classifier layer
    model.classifier[-1] = nn.Linear(in_features, num_classes)  # logits
    return model
