...
def main():
    ...
    ap.add_argument("--ckpt-ram",   type=str, default='/mnt/d9b25a57-72aa-4635-b6e9-bf7337153bb8/brain_tumor/fuse _2/checkpoints/ram_finetuned_brain_tumor_best.pth')
    ap.add_argument("--ckpt-dense", type=str,default= '/mnt/d9b25a57-72aa-4635-b6e9-bf7337153bb8/brain_tumor/fuse _2/outputs_densenet201/best_model.pt',
                    help=".pt/.pth of your custom MultiBranchDenseNet201")
    ap.add_argument("--ckpt-vgg16", type=str, default= '/mnt/d9b25a57-72aa-4635-b6e9-bf7337153bb8/brain_tumor/fuse _2/checkpoints/best_vgg16_brain.pth')
