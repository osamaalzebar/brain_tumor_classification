...
def main():
    ...
    parser.add_argument("--image_dir", type=str, default="/mnt/d9b25a57-72aa-4635-b6e9-bf7337153bb8/brain_tumor/bangladesh_mri/Raw/data",
                        help="Folder containing images referenced in CSV")
    parser.add_argument("--csv_file", type=str, default="/mnt/d9b25a57-72aa-4635-b6e9-bf7337153bb8/brain_tumor/bangladesh_mri/Raw/image_labels.csv",
                        help="CSV with Image_path and optional label")
    parser.add_argument("--ckpt", type=str, default="/mnt/d9b25a57-72aa-4635-b6e9-bf7337153bb8/brain_tumor/fuse/outputs_densenet201/best_model.pt",
