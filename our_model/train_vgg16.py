...
def parse_args():
    p = argparse.ArgumentParser(description="Fine-tune VGG16 on brain MRI with separate train/val sets.")
    ...
    p.add_argument("--out", type=str, default="best_vgg16_brain_cls.pth")
    p.add_argument("--epochs", type=int, default=30)  # per request
